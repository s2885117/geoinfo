...
class CreateInfrastructuresTable extends Migration {
  ...
  public function up()
  {
    Schema::create('infrastructures', function($table) {
      ...
      $table->string('fixedInfrastructureNo')->nullable();
      $table->string('fixedInfrastructureD')->nullable();
      ...
      $table->string('irrigationFacilitiesNo')->nullable();
      $table->string('irrigationFacilitiesD')->nullable();
      ...
      $table->string('retainingWallsNo')->nullable();
      $table->string('retainingWallsD')->nullable();
      ...
      $table->string('InfraforOpComment')->nullable();
      $table->string('OpWorksComment')->nullable();
      $table->string('GravelFillPermitReq')->nullable();
      $table->string('GravelFillPermitReqEntity')->nullable();
      $table->string('GravelFillTransPermitReq')->nullable();
      $table->string('GravelFillTransPermitReqEntity')->nullable();
      $table->string('TopSoilPermitReq')->nullable();
      $table->string('TopSoilPermitReqEntity')->nullable();
      $table->string('TopSoilTransPermitReq')->nullable();
      $table->string('TopSoilTransPermitReqEntity')->nullable();
      $table->timestamps();
    });
  }
